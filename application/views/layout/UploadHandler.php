...
class UploadHandler
{
    ...
    function __construct($options = null,$gallery_id ='test', $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/public/product/'.$gallery_id.'/',
            'upload_url' => $this->get_full_url().'/public/product/'.$gallery_id.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    public function getJson($print_response = true) {
        if ($print_response && isset($_GET['download'])) {
            return $this->download();
        }
        $file_name = $this->get_file_name_param();
