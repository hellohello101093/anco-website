...
<div class="portlet box blue">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action='<?php echo base_url()?>admin/service/<?php echo $action ?>/<?php echo  (isset($info['id']))?$info['id']:"" ?>' class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <img src="<?php echo base_url() ?>public/service/<?php echo $info['avatar'] ?>" alt=" " height="100" />
                        </div>
                    </div>
                    <?php } ?>
                    <div class="form-group">
                ...
                <div class="form-actions nobg fluid">
                    <div class="col-md-offset-3 col-md-9">
                        <a href="<?php echo base_url() ?>admin/service/listall"  class="btn default">Hủy bỏ</a>
